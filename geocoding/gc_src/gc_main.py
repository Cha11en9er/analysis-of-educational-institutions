...
INPUT_DATA_FILE = os.path.join(INPUT_DIR, 'gc_2gis_input_data.json')
OUTPUT_DATA_FILE = os.path.join(OUTPUT_DIR, 'gc_2gis_output_data.json')
...
for school in schools:
    ...
    result = geocode_address(school['adres'])
