...
GM_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, "..", "..", ".."))
DATA_DIR = os.path.join(GM_ROOT, "gm_data")
INPUT_DIR = os.path.join(DATA_DIR, "gm_input")
OUTPUT_DIR = os.path.join(DATA_DIR, "gm_output")
HTML_FILE = os.path.join(INPUT_DIR, "gm_debug_html", "gm_debug_html.html")
JSON_FILE = os.path.join(OUTPUT_DIR, "gm_data_all_schools.json")
