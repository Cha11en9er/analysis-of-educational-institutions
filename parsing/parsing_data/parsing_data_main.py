...
FILES = {
    'yandex': BASE_PATH / 'yandex_maps' / 'data' / 'ym_find_all_info' / 'output' / 'ym_full_schools_data.json',
    '2gis': BASE_PATH / '2gis' / 'data' / '2gis_all_school_with_info.json'
}
OUT_FILE = BASE_PATH / 'parsing_data' / 'gold_school_data.json'
# --------------------------------
