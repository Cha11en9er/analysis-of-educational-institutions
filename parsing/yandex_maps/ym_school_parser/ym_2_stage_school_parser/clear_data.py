...
INPUT_FILE = os.path.join(YM_ROOT, "ym_data", "ym_2_stage_data", "output", "ym_full_school_data.json")
OUTPUT_FILE = os.path.join(YM_ROOT, "ym_data", "ym_2_stage_data", "output", "ym_full_school_data_clear.json")
