...
def main():
    ...
    ym_root = os.path.abspath(os.path.join(script_dir, "..", "..", ".."))
    data_dir = os.path.join(ym_root, "ym_data")
    input_dir = os.path.join(data_dir, "ym_input")
    output_dir = os.path.join(data_dir, "ym_output")
    
    html_file = os.path.join(input_dir, "ym_maps_school.html")
    output_file = os.path.join(output_dir, "ym_school_output.json")
